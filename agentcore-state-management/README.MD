...
<p align="center"> <img src="screenshots/session_1.png" alt="Session 1 — Initial Setup & Turn 1" width="850"> </p>
...
<p align="center"> <img src="screenshots/session_2.png" alt="Session 2 — Multi-Turn Context Retention & Tool Invocation" width="850"> </p>
Implementation Checklist

All core requirements for short-term memory management have been completed:

 Create a memory resource using agentcore memory create WanderBot and store the resource ID in MEMORY_ID.
 Import HookProvider, HookRegistry, AgentInitializedEvent, and MessageAddedEvent from strands.hooks.
 Configure memory_client, memory_id, and last_k_turns in the hook provider.
 Register AgentInitializedEvent with on_agent_initialized.
 Register MessageAddedEvent with on_message_added.
 Build the Agent with ShortTermMemoryHookProvider.
 Pass explicit session_id and actor_id through the agent state.
 Run a continuous multi-turn conversation demonstrating context retention without re-prompting the user.
...
Destination: The user establishes Barcelona as the destination and specifies a budget-oriented trip.
Hotel Search: The user asks for hotels under $150 per night without repeating the destination.
Follow-Up: The user asks about cancellation policies without explicitly specifying the destination or hotels again.
